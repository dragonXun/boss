...
public class SmsUtils {
    ...
    static final String accessKeyId = "LTAI0qwpiZZmi6Ri";
    static final String accessKeySecret = "C94S8x81K29RmRiWaIPrxxLYDAz5xb";
    ...
    public static SendSmsResponse sendSms(String telephone, String code)
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("龙Xun");
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_127925083");
    ...
    public static void main(String[] args)
        ...
        // 发短信
        SendSmsResponse response = sendSms("13714403470", "123456");
